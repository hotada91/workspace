...
//		medicineHistory = new byte[CLUSTER_SIZE];
	...
	public Information(byte[] cdata)
	{
		...
		Utility.copyArray(cdata,(byte)0,this.CMND,(byte)offset,INFO_CMND_SIZE);
		offset += INFO_CMND_SIZE;			
		Utility.copyArray(cdata,(byte)0,this.birthDay,(byte)offset,INFO_BIRTHDAY_SIZE);
		offset += INFO_BIRTHDAY_SIZE;
		Utility.copyArray(cdata,(byte)0,this.bloodClass,(byte)offset,INFO_BLOOD_CLASS_SIZE);
